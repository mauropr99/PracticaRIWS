...
class FilmAffinitySpider(Spider):
    ...
    def parse(self, response):
        ...
        for movie in response.css('li ul'):
            ...
            faItem['director'] = movie.css('div.mc-director div.credits a::text').getall()

            faItem['cast'] = movie.css('div.mc-cast div.credits a::text').getall()
            ...
            faItem['poster'] = movie.css('div.mc-poster a img::attr(src)').get()
